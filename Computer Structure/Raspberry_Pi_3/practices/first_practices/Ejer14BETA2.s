...
/* Apago todos     10987654321098765432109876543210 */
	...
	subs r2, #1
									@ Decremento
	mov r3, r2							@ ALMACENO CONTADOR TRAS DECREMENTO
	moveq r2, #6 							@ Si es 0, volver a 6
	str r2, [r1]							@ Escribo cuenta y resto 4 a puntero r1
	ldr r2, [r1, +r2, LSL #2] 					@ Leo secuencia
									@ multiplico por 8 porque añado los microseg (sonido)
...
/* Hago sonar altavoz invirtiendo estado de bitson (onda cuadrada ceros y unos)*/
	ldr r10, [r9]
	eors r10, #1
	str r10, [r9], #4						@ a r9 (puntero) le sumo 4 (lo llevo a la siguiente palabra: cuenta)
