...
/* guia bits 	   10987654321098765432109876543210 */
	...
	ldr r6, =125000
	ldr r9, =6000000					@ tiempo que se ejecutará el programa
...
todo:
	push {lr}
	ldr r10, [r2, # STCLO ] 				@ Lee contador en r5
	add r10, r9						@ r6 = r5 + x segundos
inicio:	
	ldr r5, [r2, # STCLO ] 					@ Lee contador en r5
	add r5, r6						@ r6 = r5 + x segundos
	str r7, [r0, # GPSET0 ]					@ Enciende GPIO9
bucle : 
...
espera2: 
	...
	ldr r3, [r2, # STCLO ] 					@ Lee contador en r3
	add r3, r6 						@ r4 = r3 + x millones
ret2: 	
	ldr r8, [ r2, # STCLO ]
	cmp r8, r3						@ Leemos CLO hasta alcanzar. cmp: op1 - op2, si op1 < op2 -> C=0. C=1 en los otros casos
