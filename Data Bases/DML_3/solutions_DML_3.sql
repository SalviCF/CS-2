...
--5 
SELECT M.ASIGNATURA, AVG(DECODE(A.GENERO,'FEM',1,0))*100"PORCENTAJE" -- FEM/TOTAL*100
...
-- DEPARTAMENTO Y LA FECHA DEL PROFESOR CON MAYOR EDAD AL LADO (TABLA PROFESORES)
...
--8
-- ASIGNATURAS EN LAS QUE SE HA MATRICULADO CADA ALUMNO
SELECT * FROM SOL_3_8;
...
--17
SELECT * FROM SOL_3_17; --PONE COMO ASIGNATURAS HUESO A ASIGNATURAS EN LAS QUE NO HAY NADIE MATRICULADO...
...
--22 ¿DOS ALUMNOS EXACTAMENTE? ¿O AL MENOS 2?
...
-- 23 EL ANIDAMIENTO ES TU AMIGO (HAY MUCHOS CAMINOS PARA LLEGAR LA MISMA SOLUCIÓN)
-- SI NO FUNCIONA ALGÚN CAMINO COMO ESPERAS, ENFÓCALO DE OTRA MANERA. TROCEAR LOS EJ
...
--24 PIENSO QUE EL SOLUCIONARIO ESTÁ MAL. ESTA ES LA SOLUCIÓN QUE CONSIDERO CORRECTA
...
--25
SELECT * FROM SOL_3_25;
-- ASIGNATURAS CON MÁS CRÉDITOS DE CADA DEPARTAMENTO
...
--27
SELECT * FROM SOL_3_27;
--CANTIDAD DE ALUMNOS A LOS QUE LES DA CLASE UN PROFESOR
...
--28 --LA SOLUCIÓN NO TIENE NADA QUE VER CON EL ENUNCIADO. PD: EL ANIDAMIENTO ES TU AMIGO
...
--29 MUY FEO RESUELTO 
SELECT * FROM SOL_3_29;


-- CODIGOS DE ASIGNATURAS CON MENOS DE 16 ALUMNOS MATRICULADOS EN EL CURSO 15/16 IMPARTIDAS POR EL DEPARTAMENTO MAS ANTIGUO
...
--30 LAS OPERACIONES CON CONJUNTOS SON TUS AMIGAS
SELECT * FROM SOL_3_30;
