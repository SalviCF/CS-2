...
-- Ejercicio 3
SELECT P.NOMBRE, P.APELLIDO1, P.APELLIDO2, D.NOMBRE, TRUNC((CONVERT(DATE, SYSDATETIME()) - P.ANTIGUEDAD)/7) AS SEMANAS_DOCENCIA, NEXT_DAY(CONVERT(DATE, SYSDATETIME()), TO_CHAR(ANTIGUEDAD, 'DAY')) "SE CUMPLE SEMANA"
FROM PROFESORES P, DEPARTAMENTOS D
WHERE P.DEPARTAMENTO = D.CODIGO
...
-- Ejercicio 6
SELECT A1.NOMBRE, TRUNC(MONTHS_BETWEEN(CONVERT(DATE, SYSDATETIME()), A1.FECHA_NACIMIENTO)/12) "EDAD 1", A2.NOMBRE, TRUNC(MONTHS_BETWEEN(CONVERT(DATE, SYSDATETIME()), A2.FECHA_NACIMIENTO)/12, 0) "EDAD 2"
...
-- Ejercicio 8
SELECT P1.NOMBRE, P1.APELLIDO1, P2.NOMBRE, P2.APELLIDO1, TRUNC(MONTHS_BETWEEN(CONVERT(DATE, SYSDATETIME()), P1.ANTIGUEDAD)/12) "AÑOS 1", TRUNC(MONTHS_BETWEEN(CONVERT(DATE, SYSDATETIME()), P2.ANTIGUEDAD)/12) "AÑOS 2"
...
WHERE ALU.DNI = MAT.ALUMNO
      ...
      AND (MONTHS_BETWEEN(CONVERT(DATE, SYSDATETIME()), FECHA_NACIMIENTO)/12) > 22
