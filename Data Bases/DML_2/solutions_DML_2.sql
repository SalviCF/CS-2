...
-- Ejercicio 8
SELECT P1.NOMBRE, P1.APELLIDO1, P2.NOMBRE, P2.APELLIDO1, TRUNC(MONTHS_BETWEEN(SYSDATE, P1.ANTIGUEDAD)/12) "A�OS 1", TRUNC(MONTHS_BETWEEN(SYSDATE, P2.ANTIGUEDAD)/12) "A�OS 2"
...
-- Ejercicio 9 FINAL
SELECT A1.NOMBRE||' '||A1.APELLIDO1 AS EL, DECODE(M1.CALIFICACION,'MH',10,'SB',9,'NT',7,'AP',5,'SP',2,0) "NOTA �L", A2.NOMBRE||' '||A2.APELLIDO1 AS ELLA, DECODE(M2.CALIFICACION,'MH',10,'SB',9,'NT',7,'AP',5,'SP',2,0) "NOTA ELLA"
FROM ALUMNOS A1, ALUMNOS A2, MATRICULAR M1, MATRICULAR M2
WHERE A1.GENERO = 'MASC'
      AND A2.GENERO = 'FEM'
      AND A1.DNI = M1.ALUMNO
...
-------------------------------------Reuni�n de tablas + orden-----------------------------------------------------

-- Ejercicio 11
SELECT ALU.NOMBRE, ALU.APELLIDO1, ALU.APELLIDO2, ASIG.NOMBRE, DECODE(MAT.CALIFICACION, 'MH', 'MATR�CULA DE HONOR',
                                                                                       'SB', 'SOBRESALIENTE',
                                                                                       'NT', 'NOTABLE',
                                                                                       'AP', 'APROBADO',
                                                                                       'SP', 'SUSPENSO',
...
-- Ejercicio 14 -----------------------------------------------------------------
SELECT ASIG.NOMBRE AS ASIGNATURA, MAT.NOMBRE AS MATERIA, PRO.NOMBRE||' '||PRO.APELLIDO1||' '||PRO.APELLIDO2 AS PROFESOR, IMP.CARGA_CREDITOS "CARGA CR�DITOS"
...
-- Ejercicio 15 ---------------------------------------------------------------------
SELECT ASIG.NOMBRE "ASIGNATURA", DEP.NOMBRE "DEPARTAMENTO", ASIG.CREDITOS "CR�DITOS", ROUND((ASIG.PRACTICOS*100)/ASIG.CREDITOS, 2) "% PR�CTICOS"
